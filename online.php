...
<legend id="leg"><strong>ONLINE USERS</strong></legend>
...
$select = mysql_query("SELECT * from online");

 //echo '<td></td><td>MEMBER ID </td><td>USERNAME</td>';

while($result = mysql_fetch_array($select))
	{
		echo '<table align="center" style="color:green">';
		echo '<tr>';
		
		echo '<td></td><td style="align:center">'.$result['session'].'  - '.$result['name'].' - '.$result['time'].'</td>';
		echo '</tr>';
		echo '</table>';
	}
