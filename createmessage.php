...
<div class="lefttop1">
  <div class="lefttopleft"> <a href="img/ri.png" rel="facebox"><img src="img/rich.png" width="150" height="40" /></a></div>
   <div class="propic">
...
$result = mysql_query("SELECT * FROM friends WHERE  friends_with = '$id' and  member_id!= '$id' and status = 'conf'    OR member_id = '$id' ");
