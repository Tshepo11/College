...
<div id="shadow" class="popup"></div>
  ...
  <div class="lefttop1">
  <div class="lefttopleft"><a href="img/ri.png" rel="facebox"><img src="img/rich.png" width="150" height="60" /></div>
   <div class="propic">
	<?php
include('connect.php');
...
?>
  ...
  <a href="deleteAccount.php" style="color:yellow">DELETE ACCOUNT</a></li>
...
?></a></li>
      <li><a href="Home.php">Home</a></li>
		...
		<a href="logout11.php?id=<?php echo $id; ?>"><font size="2" class="font1">Logout</font></a>
        </li>
      </ul>
